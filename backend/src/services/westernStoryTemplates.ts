...
// ============================================
// Non-Romance Story Templates
// Themes: Business, Growth, Wealth, Career, Fitness, Travel
// ============================================

const NON_ROMANCE_TEMPLATES: StoryTemplate[] = [
  // ============================================
  // TEMPLATE 21: Business/Entrepreneurship
  // ============================================
  {
    ...
    genre: 'Business',
    emotion: 'Ambition',
    themeKeywords: ['entrepreneurship', 'tech startup', 'funding', 'pitch', 'scaling', 'ipo'],
    summary: 'A brilliant software engineer quits their stable job to build a revolutionary AI startup. Over 30 days, navigate the challenges of founding a company: recruiting co-founders, pitching to VCs, building the MVP, landing first customers, and scaling from garage to Series A.',
    visualStyle: {
      toneColor: 'Modern blue and white with vibrant accent colors, clean tech aesthetic',
      settingImagery: 'Co-working spaces, sleek offices, server rooms, conference rooms, Silicon Valley',
      characterAesthetics: 'Casual smart (hoodies, blazers), professional yet modern, laptop always in hand',
      moodDetails: 'Energized and focused, late-night coding sessions, celebratory team moments',
    },
    emotionalTone: 'Driven and ambitious, balancing stress with breakthrough moments, team camaraderie',
    storyHooks: ['Last-minute pitch prep', 'Product demos gone wrong', 'Investor drama', 'Team conflicts'],
    episodes: [
      { day: 1, plot: 'Quit the job, sketch the startup idea on a napkin.' },
      { day: 2, plot: 'Convince a talented friend to become co-founder CTO.' },
      { day: 3, plot: 'Build the MVP in a frenzied 48-hour coding session.' },
      { day: 4, plot: 'First pitch to an angel investor - rejection but valuable feedback.' },
      { day: 5, plot: 'Pivot the product based on user testing insights.' },
      { day: 6, plot: 'Land the first paying customer after 50 cold emails.' },
      { day: 7, plot: 'Recruit the first employees from a startup networking event.' },
      { day: 8, plot: 'Move operations from garage to proper office space.' },
      { day: 9, plot: 'Critical server outage during customer demo - handle it gracefully.' },
      { day: 10, plot: 'Competitor launches copycat product - differentiation strategy.' },
      { day: 11, plot: 'Major tech blog features the startup - first press coverage.' },
      { day: 12, plot: 'Co-founder disagreement on product direction - resolve through data.' },
      { day: 13, plot: 'Prepare for Series A pitch to top-tier VC firm.' },
      { day: 14, plot: 'Due diligence marathon - financials, references, tech deep-dive.' },
      { day: 15, plot: 'Term sheet arrives! Celebrate with the team.' },
      { day: 16, plot: 'Negotiate valuation and board seats - tense moments.' },
      { day: 17, plot: 'Hire key executives from big tech companies.' },
      { day: 18, plot: 'Product launch at major industry conference.' },
      { day: 19, plot: 'First viral moment - 100K users in one weekend.' },
      { day: 20, plot: 'Handle scaling challenges - server crashes, customer support flood.' },
      { day: 21, plot: 'Competitor acquisition offer - stay independent or sell?' },
      { day: 22, plot: 'Team culture crisis as company grows past 50 employees.' },
      { day: 23, plot: 'International expansion - first office in London.' },
      { day: 24, plot: 'Major partnership announcement with Fortune 500 company.' },
      { day: 25, plot: 'Revenue milestone: $1M ARR celebration.' },
      { day: 26, plot: 'Prepare for Series B - sky\'s the limit.' },
      { day: 27, plot: 'Founder burnout - learn to delegate and trust the team.' },
      { day: 28, plot: 'Industry award nomination - recognition among peers.' },
      { day: 29, plot: 'Reflect on the journey from idea to empire.' },
      { day: 30, plot: 'Ring the bell at stock exchange - IPO day.' },
    ],
  },

  // ============================================
  // TEMPLATE 22: Personal Growth/Fitness
  // ============================================
  {
    ...
    summary: 'An ordinary person commits to a complete physical and mental transformation over 30 days. Follow the journey from couch potato to fitness enthusiast: gym anxiety, first workouts, nutrition overhaul, mental hurdles, breakthrough moments, and discovering inner strength.',
    visualStyle: {
      toneColor: 'Vibrant oranges and greens, energetic and motivating',
      settingImagery: 'Gyms, home workout spaces, healthy kitchens, running trails, yoga studios',
      characterAesthetics: 'Athletic wear (sports bras, leggings, tank tops), progress photos visible',
      moodDetails: 'Sweat and determination, proud smiles, exhausted but accomplished',
    },
    emotionalTone: 'Empowering and relatable, showing vulnerability and triumph over self-doubt',
    storyHooks: ['Workout failures and successes', 'Nutrition struggles', 'Mindset shifts', 'Scale victories'],
    episodes: [
      { day: 1, plot: 'Take before photos, weigh in, feel overwhelmed but committed.' },
      { day: 2, plot: 'First gym session - intimidation and beginner mistakes.' },
      { day: 3, plot: 'Body so sore can barely move - question the decision.' },
      { day: 4, plot: 'Research proper form and create realistic workout plan.' },
      { day: 5, plot: 'Clean out kitchen, donate junk food, stock healthy groceries.' },
      { day: 6, plot: 'First healthy meal prep - cooking for the week.' },
      { day: 7, plot: 'Rest day and active recovery - yoga and stretching.' },
      { day: 8, plot: 'First compliment from friend - motivation boost.' },
      { day: 9, plot: 'Cheating temptation - birthday cake at office - make smart choice.' },
      { day: 10, plot: 'Measure progress: inches lost, strength increased.' },
      { day: 11, plot: 'Workout buddy joins - accountability partnership formed.' },
      { day: 12, plot: 'Plateau hits - same weight for three days - push through.' },
      { day: 13, plot: 'Try new fitness class (spin, boxing, pilates) - expand horizons.' },
      { day: 14, plot: 'Social event - resist unhealthy food peer pressure.' },
      { day: 15, plot: 'Halfway point - midway photos show real progress.' },
      { day: 16, plot: 'Increase workout intensity - add weights and HIIT.' },
      { day: 17, plot: 'Mental breakthrough - realize this is lifestyle change, not quick fix.' },
      { day: 18, plot: 'Clothes fit differently - shopping for new size.' },
      { day: 19, plot: 'Workout becomes routine, not chore - mindset shift.' },
      { day: 20, plot: 'Fitness challenge at gym - compete and place well.' },
      { day: 21, plot: 'Share progress on social media - inspire others.' },
      { day: 22, plot: 'Tough day emotionally - workout becomes therapy, not punishment.' },
      { day: 23, plot: 'Run first 5K without stopping - major milestone.' },
      { day: 24, plot: 'Old friends notice transformation - curious about the secret.' },
      { day: 25, plot: 'Cheat meal planned - enjoy guilt-free with portion control.' },
      { day: 26, plot: 'Lift heavier than ever before - strength gains evident.' },
      { day: 27, plot: 'Plan post-30-day fitness goals - this is just the beginning.' },
      { day: 28, plot: 'Reflection journal - emotional changes as significant as physical.' },
      { day: 29, plot: 'Final workout and measurements - incredible transformation.' },
      { day: 30, plot: 'After photos and celebration - new person, new life.' },
    ],
  },

  // ============================================
  // TEMPLATE 23: Wealth Display/Luxury
  // ============================================
  {
    id: 'luxury_lifestyle',
    title: 'Born Rich',
    genre: 'Lifestyle',
    emotion: 'Aspiration',
    themeKeywords: ['luxury', 'wealth', 'exotic cars', 'mansions', 'travel', 'high-end shopping', 'vip'],
    summary: 'Step into the world of extreme wealth - private jets, supercars, yacht parties, exclusive clubs, and living life without budget constraints. Experience the thrill and occasional emptiness of having everything money can buy.',
    visualStyle: {
      toneColor: 'Gold and black, luxurious and premium aesthetic',
      settingImagery: 'Penthouse apartments, exotic car dealerships, yacht decks, VIP clubs, first-class lounges',
      characterAesthetics: 'Designer fashion (Gucci, Louis Vuitton), Rolex watches, immaculately groomed',
      moodDetails: 'Confident and carefree, champagne toasts, sunset views, effortless luxury',
    },
    emotionalTone: 'Aspirational and glamorous, with hints of isolation and search for meaning',
    storyHooks: ['Exclusive parties', 'Luxury purchases', 'VIP treatment', 'Hidden costs of wealth'],
    episodes: [
      { day: 1, plot: 'Wake up in penthouse suite - city views from bed.' },
      { day: 2, plot: 'Personal chef prepares breakfast, driver takes to office.' },
      { day: 3, plot: 'Purchase new supercar - cash, no financing needed.' },
      { day: 4, plot: 'VIP table at hottest club - bottle service, no line.' },
      { day: 5, plot: 'Private shopping experience at flagship boutique.' },
      { day: 6, plot: 'Impromptu trip - private jet to Paris for dinner.' },
      { day: 7, plot: 'Yacht day with friends - captain, crew, champagne.' },
      { day: 8, plot: 'Exclusive art auction - bid millions without hesitation.' },
      { day: 9, plot: 'Front row seats at Fashion Week - meet designers backstage.' },
      { day: 10, plot: 'Personal trainer comes to home gym - luxury wellness.' },
      { day: 11, plot: 'Host charity gala - donate, network, make difference.' },
      { day: 12, plot: 'Buy vacation property on whim - Mediterranean villa.' },
      { day: 13, plot: 'Golf at country club - network with other wealthy members.' },
      { day: 14, plot: 'Private concert booking - favorite artist plays living room.' },
      { day: 15, plot: 'Family asks for loans - navigate boundary issues.' },
      { day: 16, plot: 'Security concerns - paparazzi, privacy invasion.' },
      { day: 17, plot: 'Luxury safari trip - five-star lodge, private guides.' },
      { day: 18, plot: 'Custom suit fitting - Savile Row tailor flies in.' },
      { day: 19, plot: 'Investment portfolio review - millions managed actively.' },
      { day: 20, plot: 'Sweetheart table for 50 - birthday party in ballroom.' },
      { day: 21, plot: 'Buy island - private escape from public eye.' },
      { day: 22, plot: 'Hire staff - house manager, chef, security, gardener.' },
      { day: 23, plot: 'Wine collection - rare vintages, personal sommelier.' },
      { day: 24, plot: 'Business class not enough - upgrade to private jet membership.' },
      { day: 25, plot: 'Luxury car collection grows - add vintage classic.' },
      { day: 26, plot: 'Philanthropy foundation launched - giving back seriously.' },
      { day: 27, plot: 'Forbes reaches out for billionaire profile feature.' },
      { day: 28, plot: 'Real moment - money doesn\'t solve all problems.' },
      { day: 29, plot: 'Reflection on privilege - responsibility of wealth.' },
      { day: 30, plot: 'Sunset from private island - appreciating the journey.' },
    ],
  },

  // ============================================
  // TEMPLATE 24: Career Success
  // ============================================
  {
    id: 'corporate_climb',
    title: 'Corner Office',
    ...
    themeKeywords: ['career', 'promotion', 'office politics', 'leadership', 'ambition', 'executive'],
    summary: 'A mid-level employee with big dreams navigates office politics, proves their worth, and climbs the corporate ladder to C-suite. From cubicle to corner office, experience the challenges and victories of career advancement.',
    visualStyle: {
      toneColor: 'Professional navy and gray with power tie accents',
      settingImagery: 'Open offices, boardrooms, corporate headquarters, business trips, networking events',
      characterAesthetics: 'Power suits (tailored blazers, cufflinks), briefcases, confident posture',
      moodDetails: 'Determined and strategic, celebration of wins, learning from setbacks',
    },
    emotionalTone: 'Ambitious and relatable, showing hard work and smart moves paying off',
    storyHooks: ['Office politics', 'Major presentations', 'Mentor relationships', 'Work-life balance'],
    episodes: [
      { day: 1, plot: 'Set career goal - VP position in 5 years.' },
      { day: 2, plot: 'Volunteer for high-visibility project - get noticed.' },
      { day: 3, plot: 'First major presentation to senior leadership - nail it.' },
      { day: 4, plot: 'Build relationship with influential mentor.' },
      { day: 5, plot: 'Navigate office politics - choose sides carefully.' },
      { day: 6, plot: 'Lead cross-functional team - demonstrate leadership.' },
      { day: 7, plot: 'Crisis at work - step up and solve it impressively.' },
      { day: 8, plot: 'Networking event - collect valuable contacts.' },
      { day: 9, plot: 'Request promotion with data-backed case.' },
      { day: 10, plot: 'Promotion to manager! First direct reports.' },
      { day: 11, plot: 'First difficult conversation with underperforming employee.' },
      { day: 12, plot: 'Represent company at industry conference.' },
      { day: 13, plot: 'Work-life balance struggles - set boundaries.' },
      { day: 14, plot: 'Pitch bold new initiative to exec team.' },
      { day: 15, plot: 'Initiative approved - lead company-wide rollout.' },
      { day: 16, plot: 'Conflict with peer - resolve professionally.' },
      { day: 17, plot: 'Business trip to close major client.' },
      { day: 18, plot: 'Client signs! Quarter\'s quota exceeded.' },
      { day: 19, plot: 'Another promotion request - Director level.' },
      { day: 20, plot: 'Mentor junior employees - build legacy.' },
      { day: 21, plot: 'Headhunted by competitor - stay or go?' },
      { day: 22, plot: 'Negotiate compensation package - know worth.' },
      { day: 23, plot: 'Director role approved - bigger team, bigger scope.' },
      { day: 24, plot: 'Company restructuring - survive and thrive.' },
      { day: 25, plot: 'Present to board of directors - future CEO potential.' },
      { day: 26, plot: 'International assignment - expand global perspective.' },
      { day: 27, plot: 'Industry award recognition - external validation.' },
      { day: 28, plot: 'Final push for VP position - interview preparation.' },
      { day: 29, plot: 'Offer extended - Executive Vice President!' },
      { day: 30, plot: 'Move into corner office - journey continues upward.' },
    ],
  },

  // ============================================
  // TEMPLATE 25: Travel/Adventure
  // ============================================
  {
    id: 'world_traveler',
    ...
    genre: 'Travel',
    emotion: 'Adventure',
    themeKeywords: ['travel', 'adventure', 'culture', 'food', 'sightseeing', 'transformation'],
    summary: 'A 30-day journey around the world - 10 countries, countless experiences, and a life-changing adventure. From Tokyo temples to Parisian cafes, Amazon rainforests to African safaris, discover the world and yourself.',
    visualStyle: {
      toneColor: 'Vibrant and colorful, reflecting each destination',
      settingImagery: 'Airports, exotic landmarks, beaches, mountains, markets, festivals',
      characterAesthetics: 'Travel-ready (backpacks, cameras, comfortable yet stylish), sun-kissed',
      moodDetails: 'Wonder and excitement, culture shock, personal growth, awe',
    },
    emotionalTone: 'Inspirational and adventurous, celebrating diversity and self-discovery',
    storyHooks: ['Cultural mishaps', 'Unexpected friendships', 'Breathtaking sights', 'Personal revelations'],
    episodes: [
      { day: 1, plot: 'Pack bags, nervously excited at airport departure.' },
      { day: 2, plot: 'Tokyo - neon lights, temples, jet lag.' },
      { day: 3, plot: 'Kyoto - traditional tea ceremony, zen gardens.' },
      { day: 4, plot: 'Seoul - K-pop culture, street food paradise.' },
      { day: 5, plot: 'Flight to Bangkok - travel vlog footage.' },
      { day: 6, plot: 'Chiang Mai - elephant sanctuary, mindfulness.' },
      { day: 7, plot: 'Singapore - futuristic city, hawker centers.' },
      { day: 8, plot: 'Bali - rice terraces, yoga retreat, spiritual awakening.' },
      { day: 9, plot: 'Sydney - Opera House, harbor bridge climb.' },
      { day: 10, plot: 'Great Barrier Reef - snorkeling wonder.' },
      { day: 11, plot: 'Dubai - luxury shopping, desert safari.' },
      { day: 12, plot: 'Cairo - pyramids, ancient history comes alive.' },
      { day: 13, plot: 'Serengeti safari - lions, elephants, sunrise game drive.' },
      { day: 14, plot: 'Cape Town - Table Mountain, penguins, wine country.' },
      { day: 15, plot: 'Flight to Europe - halfway point reflection.' },
      { day: 16, plot: 'Rome - Colosseum, Vatican, authentic pasta.' },
      { day: 17, plot: 'Venice - canals, gondolas, romantic atmosphere.' },
      { day: 18, plot: 'Paris - Eiffel Tower, Louvre, croissants.' },
      { day: 19, plot: 'Barcelona - Gaudí architecture, tapas culture.' },
      { day: 20, plot: 'Amsterdam - canals, museums, bike riding.' },
      { day: 21, plot: 'London - royalty, pubs, Tower of London.' },
      { day: 22, plot: 'Edinburgh - castles, whisky, rugged highlands.' },
      { day: 23, plot: 'Reykjavik - northern lights, geothermal springs.' },
      { day: 24, plot: 'New York City - Statue of Liberty, Broadway, energy.' },
      { day: 25, plot: 'Road trip to Grand Canyon - natural wonder.' },
      { day: 26, plot: 'Los Angeles - Hollywood sign, Santa Monica pier.' },
      { day: 27, plot: 'Las Vegas - shows, neon, desert oasis.' },
      { day: 28, plot: 'Costa Rica - zip-lining, cloud forest, pura vida.' },
      { day: 29, plot: 'Travel journal - life-changing experiences documented.' },
      { day: 30, plot: 'Home - transformed, planning next adventure.' },
    ],
  },
];
